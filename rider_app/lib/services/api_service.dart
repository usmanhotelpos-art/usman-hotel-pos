...
class ApiService {
  ...
  static Future<Rider> getRiderInfo() async {
    final res = await http
        .get(
          Uri.parse('$_baseUrl/auth/rider-me'),
  ...
  // Orders
  static Future<List<Map<String, dynamic>>> getAssignedOrders(String riderId) =>
      _fetchList('$_baseUrl/rider/assigned-orders/$riderId');

  static Future<List<Map<String, dynamic>>> getDeliveredOrders(
    String riderId,
    String paymentMethod,
  ) => _fetchList('$_baseUrl/rider/delivered-orders/$riderId/$paymentMethod');

  static Future<List<Map<String, dynamic>>> getAllOrders() =>
      _fetchList('$_baseUrl/pos/orders');
