...
const List<String> allowedRoles = ['Order Taker', 'Admin Order Taker', 'Takeaway Order Taker', 'Table Order Taker', 'Waiter', 'Helper', 'Cashier', 'Admin', 'Manager', 'Admin Rider', 'Biker', 'Rider'];
...
Future<String?> refreshTokenOp(String stored) async {
  ...
  if (newToken != null && newToken.isNotEmpty) {
    await SharedPreferences.getInstance().then((p) {
      p.setString('deliveryToken', newToken);
    });
  }
  return newToken;
}
